...
public class MybatisPlusGeneratorUtils {
    ...
    public MybatisPlusGeneratorUtils init(String Author, SpringBootApplicationConfig springBootApplicationConfig){
        this.Author=Author;
    ...
    public void createTableInfo(String...tableNames){
        ...
        auto.setGlobalConfig(new GlobalConfig()
                ...
                // 这里的名称要与模板中进行对应
                .setServiceName("I%sService").setServiceImplName("%sServiceImpl").setMapperName("I%sDao").setXmlName("I%sDao")
        );
        ...
        auto.setPackageInfo(new PackageConfig()
                ...
                //.setModuleName("model")
                // 分层包名
                .setService("service").setServiceImpl("service.impl").setEntity("model").setMapper("dao").setXml("xml"));
