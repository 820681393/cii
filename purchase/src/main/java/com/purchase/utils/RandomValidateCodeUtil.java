...
/**
 * Created by Miracle on 2020/3/20.
 */
public class RandomValidateCodeUtil {

    private static final MyLogger LOG = new MyLogger(RandomValidateCodeUtil.class);
    /**
     * 随机产生数字与字母组合的字符串
     */
    ...
    public String getRandCode(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            base64 =  "data:image/jpg;base64,"+Base64Util.encryptBASE64(stream.toByteArray());
        } catch (Exception e) {
