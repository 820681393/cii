...
import com.purchase.config.ErrorMailNoticeConfig;
...
class MiningApplicationTests {
    ...
    public static void main(String[] args) throws IOException {
        ...
        File f2 = new File(MiningApplicationTests.class.getResource("").getPath());
        System.out.println(f2);
        System.out.println(getAppPath(MiningApplicationTests.class));
    }
    /**-----------------------------------------------------------------------
